  ...
  if(mysqli_num_rows($result) === 1) {
    ...
    if(password_verify($password, $row["password"])) {
      if($row['status'] == 'Aktif'){
        ...
        if($row['role'] === 'admin') {
          header("Location: ../tampilan/admin/home/home.php");
          exit();
        }else{
          header("Location: ../tampilan/pegawai/home/home.php");
          exit();
        }
      }else{
      ...
      <div class="container container-tight py-4">
        <div class="text-center mb-4">
          <a href="." class="navbar-brand navbar-brand-autodark">
            <img src="<?= base_url('assets/img/tvri.logo1.svg')?>" width="110" height="50" alt="Tabler" class="navbar-brand-image">
          </a>
        </div>

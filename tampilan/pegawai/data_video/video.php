...
<div class="page-body">
    ...
    <form method="GET" action="" class="me-2">
            ...
            <a href="<?= base_url('tampilan/pegawai/data_video/tambah.php')?>" class="btn btn-primary">
            ...
            <?php } else { ?>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="<?= base_url('tampilan/pegawai/data_video/detail.php?id=' .$video['id'])?>" class="badge badge-pill bg-primary">Detail</a>
                        <a href="<?= base_url('tampilan/pegawai/data_video/edit.php?id=' .$video['id'])?>" class="badge badge-pill bg-primary">Edit</a>
                    </td>
                </tr>
                <?php endwhile; ?> 
            <?php } ?>

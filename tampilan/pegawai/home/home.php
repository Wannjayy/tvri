                  ...
                  <div class="col-sm-6 col-lg-3">
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="bg-black text-white avatar"><!-- Download SVG icon from http://tabler-icons.io/i/brand-facebook -->
                              <i class="fa-brands fa-tiktok"></i>
                            </span>
                          </div>
                          <div class="col">
                            <div class="font-weight-medium">
                              <?= $total_tiktok_video ?> Video
                            </div>
                            <div class="text-secondary">
